...
#        model.Params.method = 2             # use barrier to solve the root relaxation
#        model.Params.NodefileStart = 30     # upper limit of memory being consumed
#        model.Params.Threads = 10           # limit the thread to reduce memory usage
